...
python3 app.py
python3 app_visualisations.py
```
The above will take about 30-40 mins to execute completely. The resultant visualisations can be found in the results-analysis directory. 
