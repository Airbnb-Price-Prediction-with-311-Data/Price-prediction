...
# airbnb = remove_na(airbnb)
# airbnb = drop_redundant_columns_rows(airbnb)
# airbnb["zipcode"] = get_zip(airbnb)
# print (airbnb.price[0])
# airbnb = format_values(airbnb)
# print (airbnb.price[0])
# airbnb = add_columns(airbnb)
airbnb.to_csv('../../dataset/Airbnb_processed_try_1.csv', index = False)
