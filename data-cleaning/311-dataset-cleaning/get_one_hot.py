...
def get_subset():
    count_by_complaint_type_and_zip = pd.read_csv('../Data/count_by_incident_zip_complaint_type_2010_to_2019.csv')
...
def write_to_file(one_hot):
    ...
    one_hot.to_csv('../Data/count_by_incident_zip_complaint_type_2010_to_2019_one_hot.csv', index=True)
