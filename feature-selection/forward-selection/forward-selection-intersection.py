...
#the values that are being compared with are baseline airbnb model values 
    ...
    final_complaints = list(set(linear_reg_services) & set(xgboost_complaints) & set(random_forest_complaints) & set(ensemble_boost_complaints) & set(knn_complaints) )
    ...
    airbnb_complaints.to_csv('../results/forward_selection_intersection.csv')
